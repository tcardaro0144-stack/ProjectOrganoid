...
print("DIRTY BEFORE TEST")
print(json.dumps(call_unreal("get_editor_state"), indent=2)[:1600])
print("PIE", json.dumps(call_unreal("get_pie_state"), indent=2)[:600])

started = call_unreal("run_playtest", {"test_id": "OpeningInvestigation_Functional"})
